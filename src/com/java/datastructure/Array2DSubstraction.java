...
public class Array2DSubstraction {
    public static void main(String[] args) {
        ...
        System.out.println("****************************************************************");
        System.out.println("Second way to do subtraction of the arrays");
        ...
        System.out.println("output of the Second way to do subtraction of the arrays");
        for (int i = 0; i < 2; i++) {
            for (int j = 0; j < 3; j++) {
